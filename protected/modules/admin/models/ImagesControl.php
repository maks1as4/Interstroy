...
class ImagesControl extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('img', 'file', 'types'=>'png,jpg,jpeg,gif', 'allowEmpty'=>false, 'maxSize'=>1024*1024*2, 'tooLarge'=>'Картинка слишком большая, разрешенно не более 2 MB.', 'minSize'=>512, 'tooSmall'=>'Картинка слишком маленькая, разрешенно не менее 512 Byte.', 'on'=>'insert'),
			array('img', 'file', 'types'=>'png,jpg,jpeg,gif', 'allowEmpty'=>true, 'maxSize'=>1024*1024*2, 'tooLarge'=>'Картинка слишком большая, разрешенно не более 2 MB.', 'minSize'=>512, 'tooSmall'=>'Картинка слишком маленькая, разрешенно не менее 512 Byte.', 'on'=>'update'),
